...
def main():
    ...
    plot_curves(train_loss_history, train_acc_history, valid_loss_history, valid_acc_history, args.config)
...
def run():
    ...
    valid_acc=valid_acc_history[-1]
    print("* Train Accuracy: {accuracy:.4f}".format(accuracy=train_acc))
    print("* Validation Accuracy: {accuracy:.4f}".format(accuracy=valid_acc))
    print("Final Accuracy on Test Data: {accuracy:.4f}".format(accuracy=test_acc))
